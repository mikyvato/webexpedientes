...
class OficinasController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Oficinas'];
			$model->descripcion= strtoupper($model->descripcion);
			$model->detalle= strtoupper($model->detalle);
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Oficinas');
	...
	{
		$model=Oficinas::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Oficinas $model the model to be validated
	 */
